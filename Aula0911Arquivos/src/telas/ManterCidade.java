...
public class ManterCidade extends javax.swing.JDialog {
// vetor dinamico para clientes

    List<Cidade> cid = new ArrayList();
    Cidade cidaux;
    // variavel para saber se ? para adicionar um novo registro ou para alterar
    // o registro corrente
    boolean novo = false;
    // variavel para saber qual o ?ndice do registro que est? sendo editado no
    // momento
    int i = -1;

    public ManterCidade(java.awt.Frame parent,
            boolean modal,
    ...
    private void initComponents() {
        ...
        rbModerna = new javax.swing.JRadioButton();
        rbFeia = new javax.swing.JRadioButton();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Dados da Cidade"));
        ...
        cbEstado.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Paraná", "Santa Catarina ", "São Paulo", "Rio Grande do Sul" }));

        buttonGroup1.add(rbModerna);
        rbModerna.setSelected(true);
        rbModerna.setText("Moderna");
        rbModerna.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbModernaActionPerformed(evt);
            }
        });

        buttonGroup1.add(rbFeia);
        rbFeia.setText("Feia");
        ...
        btPrimeiro.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/control_rewind_blue.png"))); // NOI18N
        ...
        btAnterior.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/control_start_blue.png"))); // NOI18N
        ...
        btProximo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/control_play_blue.png"))); // NOI18N
        ...
        btUltimo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/control_fastforward_blue.png"))); // NOI18N
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        boolean moderna
                = rbModerna.isSelected() ? true : false;
        // criando um objeto com os dados da tela
        cidaux = new Cidade(codc, nome, estado, moderna);
    ...
    private void btUltimoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btUltimoActionPerformed
        // TODO add your handling code here:
        if ((cid.size() > 0) && (i < cid.size() - 1)) {
            i = cid.size() - 1; // vai para o ?ltimo registro
            carregaDados();
        } else {
            JOptionPane.showMessageDialog(this, "Já está no último registro");
        }
    ...
    private void rbModernaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbModernaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rbModernaActionPerformed
    ...
    private void carregaDados() {
        ...
        // armazenado em i
        cidaux = cid.get(i); // recupera o cliente armazenado em i
        tfCodigo.setText(cidaux.getCodCidade() + "");
        tfNome.setText(cidaux.getCidade());
        cbEstado.setSelectedItem(cidaux.getEstado());
        rbModerna.setSelected(cidaux.isModerna());
        rbFeia.setSelected(!cidaux.isModerna());
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ManterCidade dialog = new ManterCidade(new javax.swing.JFrame(), true, null);
    ...
    private javax.swing.JRadioButton rbFeia;
    private javax.swing.JRadioButton rbModerna;
